...
public class ProcessoSeletivo {
    ...
    static void entrandoEmContato(String candidato){
        ...
        do {
            ...
            if(continuarTentando)
                ...
                System.out.println("CONTADO FOI REALIZADO COM SUCESSO");
    ...
    static void imprimirSelecionados(){
        ...
        for(String candidato: candidatos){
            System.out.println("O candidato foi selicionado foi "+ candidato);
        }
    }

    static void selecaoCandidatos(){
    String  [] candidatos = {"FELIPE","YTALLO", "JOAO" ,"PEDRO", "JULIA","MARCIA", "PAULO" , "JULIANO", "FELIPE" , "GUSTAVO"};
